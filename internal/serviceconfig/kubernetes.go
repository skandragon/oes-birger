...
// tunnel.
func (ke *KubernetesEndpoint) ExecuteHTTPRequest(ctx context.Context, _ string, echo Echo, req *pb.TunnelRequest) error {
	...
	RunHTTPRequest(ctx, cancel, client, req, httpRequest, echo, c.serverURL)
	return nil
}
